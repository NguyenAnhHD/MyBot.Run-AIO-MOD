...
Func TrainRevamp()
	...
	If Not $g_bQuickTrainEnable And $ichkSmartTrain = 0 Then	; SmartTrain - Demen
		TrainRevampOldStyle()
		Return
	EndIf
	...
	If $ichkSmartTrain = 1 Then				;	SmartTrain - Demen
		SmartTrain()
...
Func TrainArmyNumber($Army, $iMultiClick = 1) ; QuickTrainCombo (Checkbox)
