...
Global $g_hEditClanMessages1 = "", $g_hEditClanMessages2 = ""

Func ChatbotGUI()
	ChatBotReadMessages()
	Local $x = 25, $y = 47
	GUICtrlCreateGroup(GetTranslatedFileIni("MOD GUI Design - Chatbot", "Group_01", "Global Chat"), $x - 20, $y - 20, 215, 360)
	$y -= 5
		$g_hChkGlobalChat = GUICtrlCreateCheckbox(GetTranslatedFileIni("MOD GUI Design - Chatbot", "GlobalChat", "Advertise in global"), $x - 10, $y, -1, -1)
			...
			GUICtrlSetOnEvent(-1, "cmbChatBot")
	$y += 18
	...
	$y += 18
		$g_hChkSwitchLang = GUICtrlCreateCheckbox(GetTranslatedFileIni("MOD GUI Design - Chatbot", "SwitchLang", "Switch languages"), $x - 10, $y, -1, -1)
			...
			GUICtrlSetState(-1, $GUI_DISABLE)
			GUICtrlSetOnEvent(-1, "cmbSwitchLang")
	...
	$y += 25
		$g_hEditGlobalMessages1 = GUICtrlCreateEdit(_ArrayToString($GlobalMessages1, @CRLF), $x - 15, $y, 202, 65)
			...
			GUICtrlSetOnEvent(-1, "ChatMessagesEdit")
	$y += 70
	...
	Local $x = 245, $y = 47
	GUICtrlCreateGroup(GetTranslatedFileIni("MOD GUI Design - Chatbot", "Group_02", "Clan Chat"), $x - 20, $y - 20, 218, 360)
	$y -= 5
	...
	$y += 25
		$g_hEditClanMessages1 = GUICtrlCreateEdit(_ArrayToString($ClanMessages1, ":", -1, -1, @CRLF), $x - 15, $y, 206, 80)
			...
			GUICtrlSetOnEvent(-1, "ChatMessagesEdit")
	$y += 92
		$g_hEditClanMessages2 = GUICtrlCreateEdit(_ArrayToString($ClanMessages2, @CRLF), $x - 15, $y, 206, 80)
