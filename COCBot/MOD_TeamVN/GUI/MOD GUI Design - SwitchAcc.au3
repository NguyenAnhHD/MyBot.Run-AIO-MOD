...
Func CreateBotSwitchAcc()
	...
	GUICtrlCreateLabel(GetTranslated(109, 10, "Total CoC Acc:"), $x + 10, $y + 29, -1, -1)
	...
	$sTxtTip = GetTranslated(109, 29, "Select CoC Account to manually locate its y-coordinate")
	GUICtrlSetData(-1, "Acc. 1" & "|" & "Acc. 2" & "|" & "Acc. 3" & "|" & "Acc. 4" & "|" & "Acc. 5" & "|" & "Acc. 6" & "|" & "Acc. 7" & "|" & "Acc. 8", "Acc. 1")
	GUICtrlSetTip(-1, $sTxtTip)

	GUICtrlCreateButton(GetTranslated(109, 30, "Locate"), $x + 80, $y + 20, 50, 23)
	GUICtrlSetTip(-1, GetTranslated(109, 31, "Starting locate your CoC Account"))
	GUICtrlSetOnEvent(-1, "btnLocateAcc")

	GUICtrlCreateButton(GetTranslated(109, 32, "Clear All"), $x + 135, $y + 20, 50, 23, $BS_MULTILINE)
	GUICtrlSetTip(-1, GetTranslated(109, 33, "Clear location data of all accounts"))
	...
	$y += 35
	GUICtrlCreateLabel(GetTranslated(109, 37, "No."), $x - 10, $y, 15, -1, $SS_CENTER)
	GUICtrlCreateLabel(GetTranslated(109, 38, "Profile Name"), $x + 10, $y, 90, -1, $SS_CENTER)
	GUICtrlCreateLabel(GetTranslated(109, 39, "Acc."), $x + 105, $y, 30, -1, $SS_CENTER)
	GUICtrlCreateLabel(GetTranslated(109, 40, "Bot Type"), $x + 140, $y, 60, -1, $SS_CENTER)
	...
	For $i = 0 To 7
		...
		$lblProfileName[$i] = GUICtrlCreateLabel(GetTranslated(109, 41, "Village Name"), $x + 10, $y + 4 + ($i) * 25, 90, 18, $SS_CENTER)
		...
		$sTxtTip = GetTranslated(109, 42, "Select the index of CoC Account to match with this Profile")
		...
		$sTxtTip = GetTranslated(109, 43, "Define the botting type of this profile")
		GUICtrlSetData(-1, GetTranslated(109, 44, "Active") & "|" & GetTranslated(109, 45, "Donate") & "|" & GetTranslated(109, 46, "Idle"))
		GUICtrlSetTip(-1, $sTxtTip)
