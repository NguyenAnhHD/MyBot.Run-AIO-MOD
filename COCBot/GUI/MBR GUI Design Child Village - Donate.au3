...
Func CreateRequestSubTab()
	...
	Local $x = $xStart
	Local $y = $yStart
	$g_hGrpRequestCC = GUICtrlCreateGroup(GetTranslated(611,1, "Clan Castle Troops"), $x - 20, $y - 20, $g_iSizeWGrpTab3, $g_iSizeHGrpTab3)
		$y += 10
		$x += 10
		GUICtrlCreateIcon($g_sLibIconPath, $eIcnCCRequest, $x - 5, $y, 64, 64, $BS_ICON)
		$g_hChkRequestTroopsEnable = _GUICtrlCreateCheckbox(GetTranslated(611,2, "Request Troops / Spells"), $x+40+30, $y-6, -1, -1)
        ...
        $chkRusLang2 = _GUICtrlCreateCheckbox(GetTranslated(611,7, "Russian request"), $x + 235, $y - 6, -1, -1)
		...
		$y += 15
		$g_ahChkRequestCCHours[0] = GUICtrlCreateCheckbox("", $x + 30, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[1] = GUICtrlCreateCheckbox("", $x + 45, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[2] = GUICtrlCreateCheckbox("", $x + 60, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[3] = GUICtrlCreateCheckbox("", $x + 75, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[4] = GUICtrlCreateCheckbox("", $x + 90, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[5] = GUICtrlCreateCheckbox("", $x + 105, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[6] = GUICtrlCreateCheckbox("", $x + 120, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[7] = GUICtrlCreateCheckbox("", $x + 135, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[8] = GUICtrlCreateCheckbox("", $x + 150, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[9] = GUICtrlCreateCheckbox("", $x + 165, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[10] = GUICtrlCreateCheckbox("", $x + 180, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[11] = GUICtrlCreateCheckbox("", $x + 195, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
        ...
        GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
		$y += 15
		$g_ahChkRequestCCHours[12] = GUICtrlCreateCheckbox("", $x + 30, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[13] = GUICtrlCreateCheckbox("", $x + 45, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[14] = GUICtrlCreateCheckbox("", $x + 60, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[15] = GUICtrlCreateCheckbox("", $x + 75, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[16] = GUICtrlCreateCheckbox("", $x + 90, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[17] = GUICtrlCreateCheckbox("", $x + 105, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[18] = GUICtrlCreateCheckbox("", $x + 120, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[19] = GUICtrlCreateCheckbox("", $x + 135, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[20] = GUICtrlCreateCheckbox("", $x + 150, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[21] = GUICtrlCreateCheckbox("", $x + 165, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[22] = GUICtrlCreateCheckbox("", $x + 180, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$g_ahChkRequestCCHours[23] = GUICtrlCreateCheckbox("", $x + 195, $y, 13, 13)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
   ...
   GUICtrlCreateGroup(GetTranslated(634,50, "____G.T.F.O"), $x - 20, $y, $g_iSizeWGrpTab3, 40)
	$g_hchkGTFO = _GUICtrlCreateCheckbox(GetTranslated(634,51, "KICK Members:"), $x + 2, $y + 5, 85, 17)
            GUICtrlSetState(-1, $GUI_UNCHECKED)
  ...
  ;~ -------------------------------------------------------------
   ...
   GUICtrlCreateGroup(GetTranslated(612,22, "Donate Troops Selection Menu"), $x - 20, $y - 20, $g_iSizeWGrpTab3, 185)
	  ...
	  $x += $Offx
       ...
       GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
	   $g_hChkExtraAlphabets = _GUICtrlCreateCheckbox(GetTranslated(612,25, "Cyrillic"), $x + 127 , $y + 149, -1, -1)
	   _GUICtrlSetTip(-1, GetTranslated(612,26, "Check this to enable the Cyrillic Alphabet."))
	   $g_hChkExtraChinese = _GUICtrlCreateCheckbox(GetTranslated(612,103, "Chinese"), $x + 191, $y + 149, -1, -1)
	   _GUICtrlSetTip(-1, GetTranslated(612,104, "Check this to enable the Chinese Alphabet."))
	   $g_hChkExtraKorean = _GUICtrlCreateCheckbox(GetTranslated(612,116, "Korean"), $x + 265, $y + 149, -1, -1)
	   _GUICtrlSetTip(-1, GetTranslated(612,117, "Check this to enable the Korean Alphabet."))
	   $g_hChkExtraPersian = _GUICtrlCreateCheckbox(GetTranslated(612,118, "Persian"), $x + 340, $y + 149, -1, -1)
...
Func CreateScheduleSubTab()
	...
	$g_hGrpDonateCC = GUICtrlCreateGroup(GetTranslated(613,1,"Donate Schedule"), $x - 20, $y - 20, $g_iSizeWGrpTab3, 120)
	   ...
	   $g_hChkDonateHoursEnable = _GUICtrlCreateCheckbox(GetTranslated(603,30, -1), $x +40+ 30, $y-6, -1, -1)
...
GUICtrlSetBkColor(-1, $GUI_BKCOLOR_TRANSPARENT)
   ...
   GUICtrlCreateGroup(GetTranslated(613,15,"Skip donation near full troops"), $x - 20, $y - 20, $g_iSizeWGrpTab3, 45)
	  ...
	  $g_hChkSkipDonateNearFullTroopsEnable = _GUICtrlCreateCheckbox(GetTranslated(613,13,"Skip donation near full troops"), $x, $y, -1, -1)
			GUICtrlSetState(-1, $GUI_CHECKED )
   ...
   GUICtrlCreateGroup(GetTranslated(634,13,"Balance Donate/Receive"), $x - 20, $y, $g_iSizeWGrpTab3, 40)
   	$y += 12
		$g_hChkUseCCBalanced = _GUICtrlCreateCheckbox(GetTranslated(634,13,"Balance Donate/Receive"), $x, $y+6, -1, -1)
			GUICtrlSetState(-1, $GUI_UNCHECKED)
