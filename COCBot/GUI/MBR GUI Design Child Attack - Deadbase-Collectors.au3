...
Func CreateAttackSearchDeadBaseCollectors()
   ...
   GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "Group_01", "Collectors"), $x - 5, $y - 20, $g_iSizeWGrpTab4, $g_iSizeHGrpTab4)
		...
		$g_hChkDBMeetCollOutside = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "ChkMeetCollOutside", "Check Collectors Outside"), $x+250, $y+90, -1, -1)
			$sTxtTip = GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "ChkMeetCollOutside_Info_01", "Search for bases that has their collectors outside.")
		...
		$g_hTxtDBMinCollOutsidePercent = GUICtrlCreateInput("50", $x+300, $y+115, 31, 20, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			$sTxtTip = GetTranslatedFileIni("MBR GUI Design Child Attack - Deadbase-Collectors", "ChkMeetCollOutside_Info_02", "Set the Min. % of collectors outside to search for on a village to attack.")
			GUICtrlSetTip(-1, $sTxtTip)
